...
const Timeline = () => {
  ...
  //get all related users post
  const getUserRelatedAllpost = async () => {
    try {
      let userId = localStorage.getItem('_id');
      let allrelatedPost = await getUserWithFriendsAllPost(userId);
      console.log('rel', allrelatedPost);
      if (allrelatedPost) {
        setStories(allrelatedPost.data);
      }
    } catch (err) {}
  };
      ...
      <section>
        <Container>
          <form onSubmit={posting}>
            <div className="row">
              <div className="col-md-8 flex border-2">
              ...
              <div className="col-md-4">
                <h4>Last Post : {}</h4>
                <div id="recent">
                  <div className="col-md-8 flex border-2 p-2 mt-2">
                    <div>{stories[0]?.body}</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-md-8 flex  border-b-2 border-l-2 border-r-2">
            ...
            <div id="posted">
              <div>
                {stories.map((story, index) => (
                  <div className="col-md-8  border-2 mt-2 p-2">
